  ...
  describe('.authentication', () => {
    describe('.getToken(username)', () => {
      it('PUTs to authentication/v1/token/:username and resolves to API response', function () {
        ...
        return expect(
          this.subject.authentication.getToken(username)
    ...
    describe('.getAllTokens(username)', () => {
    ...
    describe('.revokeTokens(username)', () => {
