import { SoftwareUpgrade } from '../models/coordinator/software-upgrade.model';
...
export class SoftwareUpgradeController {
  ...
  get(upgradeInstanceId) {
    return this.itemsenseService.makeRequest(
      this.model,
      SoftwareUpgrade.requestTypes.GET,
      null,
      upgradeInstanceId
    );
  }
  ...
  start(upgradeData) {
    return this.itemsenseService.makeRequest(
      this.model,
      SoftwareUpgrade.requestTypes.START,
      upgradeData
    );
  }
  ...
  stop(upgradeInstanceId) {
    return this.itemsenseService.makeRequest(
      this.model,
      SoftwareUpgrade.requestTypes.STOP,
      null,
      upgradeInstanceId
    );
  }
  ...
  trigger(dataForUpgrade) {
    return this.itemsenseService.makeRequest(
      this.model,
      SoftwareUpgrade.requestTypes.TRIGGER,
      dataForUpgrade
    );
  }
