...
For more information about ItemSense and its APIs, check out http://developer.impinj.com.
...
itemsense.authentication.validateToken(token) // validates a specific token id
